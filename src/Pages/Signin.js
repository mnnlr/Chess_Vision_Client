    ...
    return (
        <>
            <div className='flex items-center justify-center '>
                <form className='items-center justify-center bg-gray-100 rounded-lg shadow-lg flex flex-col md:mx-96 md:flex-row p-10 m-3 '>
                    <div className=''>
                        ...
                        <div className="border-b border-gray-900/10 ">
                            <div className="mt-10 grid grid-col gap-y-5">
                                <div className="sm:col-span-7">
                                    ...
                                    <div className="mt-2">
                                        <input type="text" name="username" id="user-name" className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                    </div>
                                </div>
                                <div className="sm:col-span-7">
