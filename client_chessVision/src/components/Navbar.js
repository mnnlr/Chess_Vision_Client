    ...
    <header className="fixed top-0 left-0 w-full z-50 text-gray-600 body-font bg-customTeal">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
          ...
          <Link to='/signup' className="py-2 px-4 transform duration-200 bg-slate-300 bg-opacity-50 hover:bg-opacity-50 hover:bg-slate-400 rounded-full hover:cursor-pointer font-bold mr-5 hover:text-gray-900">Sign Up</Link>
          <Link to='/signin' className="py-2 px-4 transform duration-200 bg-slate-300 bg-opacity-50 hover:bg-opacity-50 hover:bg-slate-400 rounded-full hover:cursor-pointer font-bold mr-5 hover:text-gray-900">Login</Link>
        </nav>
      </div>
    </header>
  );
